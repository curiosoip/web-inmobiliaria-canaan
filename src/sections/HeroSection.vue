  ...
  <section id="inicio" class="relative h-screen overflow-hidden">
    ...
    <div class="relative z-10 flex items-center justify-center h-full">
      <div class="text-center text-white px-4 sm:px-6 lg:px-8 max-w-8xl mx-auto">
        ...
        <div
          class="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center  px-4"
        >
          <a
            href="/urbanizaciones/lapaz/"
            class="w-full gap-2 sm:w-auto bg-amber-500 hover:text-slate-950 text-slate-800 font-bold px-8 sm:px-12 py-2 text-base sm:text-lg rounded-lg transition-all duration-300 group flex items-center justify-center"
          >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 14 14"><path fill="currentColor" fill-rule="evenodd" d="M7 0c2.622 0 4.806 2.184 4.806 4.805c0 .856-.294 1.7-.705 2.464c-.413.768-.959 1.484-1.501 2.094a16 16 0 0 1-1.521 1.49a9 9 0 0 1-.546.433a3 3 0 0 1-.195.13a1 1 0 0 1-.174.083a.54.54 0 0 1-.405-.03a1 1 0 0 1-.098-.053a3 3 0 0 1-.196-.133a9 9 0 0 1-.545-.435A16 16 0 0 1 4.4 9.352c-.542-.612-1.088-1.33-1.5-2.095c-.411-.762-.706-1.603-.706-2.452C2.194 2.184 4.378 0 7 0m0 6.24a1.435 1.435 0 1 1 0-2.87a1.435 1.435 0 0 1 0 2.87m3.1 3.916q.276-.31.55-.65h1.343c.2 0 .38.12.46.303l1.497 3.495a.5.5 0 0 1-.46.697H.51a.5.5 0 0 1-.46-.697l1.498-3.495a.5.5 0 0 1 .46-.303h1.355q.266.33.537.636c.662.746 1.33 1.376 1.85 1.821c.26.223.487.402.661.528q.13.095.232.157q.049.03.11.06q.03.014.079.03a.55.55 0 0 0 .414-.03q.06-.029.11-.059q.101-.061.231-.155c.174-.126.4-.304.661-.525c.52-.442 1.19-1.069 1.851-1.813" clip-rule="evenodd"/></svg>
            Elige tu lugar ideal
          </a>
...
import postervid from "../assets/imgs/postervid.jpg";
import postervid2 from "../assets/imgs/postervid2.jpg";
import postervid3 from "../assets/imgs/postervid3.jpg";
interface Slide {
  id: number;
  title: string;
  subtitle: string;
...
const slides = ref<Slide[]>([
  { id: 1, title: "TE AYUDAMOS A", subtitle: "CONSTRUIR TU FUTURO", video: "https://bucket.fabcode.dev/bginit.webm" ,poster:postervid.src },
  { id: 2, title: "EL LUGAR QUE SUEÑAS", subtitle: "LISTO PARA TÍ", video: "https://bucket.fabcode.dev/bgviterreno.webm",poster:postervid2.src },
  { id: 3, title: "HAZ REALIDAD", subtitle: "TU GRAN PROYECTO", video: "https://bucket.fabcode.dev/bgvid.webm",poster:postervid3.src },
]);
